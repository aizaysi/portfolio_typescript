...
const Terminal: React.FC = () => {
  ...
  const SkipIntro = () => {
    ...
    setText1("ssh geust@Aizaysi.dev");
  ...
  useEffect(() => {
    if(start) {
      document.addEventListener("keydown", function (event) {
        if (event.key === "Enter") {
          if (!Text3.includes("Access")) {
            ...
            setText1("ssh geust@Aizaysi.dev");
            setText2("geust@Aizaysi.dev's password:");
            setText3("Access Granted!");
          }
          ...
          if (CommandArea) {
            ...
            if(previousCommand.length>0) {
              setprevusedCommand(prevArray => [...prevArray, "guest@Aizaysi.dev:~$ " + previousCommand]);
              /*if (CommandArea.value === "github") {
                window.open("https://github.com/aizaysi", "_blank");
              }
              else if (CommandArea.value === "twitter") {
                window.open("https://Aizaysi.dev", "_blank");
              }
              else if (CommandArea.value === "telegram") {
                window.open("https://github.com/aizaysi/portfolio", "_blank");
              }
      ...
      Typewriter({ text: "ssh geust@Aizaysi.dev", delay: 100, func: setText1 });
      ...
      setTimeout(() => {
        setText3("Connecting to geust@Aizaysi.dev...");
      }, 4300);
                ...
                if (item.match(new RegExp(`\\b${"discord"}\\b`, "g"))) {
                  return (
                    <div  className="mcq-wrapper">
                      ...
                      <ul id="mcq" className="mcq">
                        <li key={index} className="mcq-option">My Discord: <a href="https://discord.com/users/775249998379614238" rel="noreferrer" target="_blank">Aizaysi.dev ↗</a></li>
                      </ul>
                      <br />
                    </div>
                  );
                  ...
                  return (
                    <div  className="mcq-wrapper">
                      <li className="userPrefix" key={index}>{item}</li>
                      <ul id="mcq" className="mcq">
                        <li key={index} className="mcq-option">My Github: <a href="https://github.com/aizaysi" rel="noreferrer" target="_blank">@aizaysi ↗</a></li>
                      </ul>
                      <br />
                    </div>
                  );
                  ...
                  return (
                    <div  className="mcq-wrapper">
                      <li className="userPrefix" key={index}>{item}</li>
                      <ul id="mcq" className="mcq">
                        <li key={index} className="mcq-option">My Email: <a href="mailto:aizaysi.success@gmail.com" rel="noreferrer" target="_blank">Aizaysi@Aizaysi.dev ↗</a></li>
                      </ul>
                      <br />
                    </div>
                  );
                  ...
                  return (
                    <div  className="mcq-wrapper">
                      <li className="userPrefix" key={index}>{item}</li>
                      <ul id="mcq" className="mcq">
                        <li key={index} className="mcq-option">My Twitter: <a href="https://twitter.com/aizaysi" rel="noreferrer" target="_blank">@aizaysi  ↗</a></li>
                      </ul>
                      <br />
                    </div>
                  );
                  ...
                  return (
                    <div  className="mcq-wrapper">
                      <li className="userPrefix" key={index}>{item}</li>
                      <ul id="mcq" className="mcq">
                        <li key={index} className="mcq-option">My Telegram: <a href="https://t.me/AizaysiWeb3" rel="noreferrer" target="_blank">@AizaysiWeb3  ↗</a></li>
                      </ul>
                      <br />
                    </div>
                  );
                  ...
                  return (
                    <div><li className="userPrefix" key={index}>{item}</li>
                      ...
                      <div className="mcq-wrapper"><br></br>
                        <ul id="mcq" className="mcq">
                          <li className="mcq-option" tabIndex={0}><a href="https://github.com/aizaysi" target='_blank' rel="noreferrer">My Github: @aizaysi ↗</a></li>
                          <li className="mcq-option" tabIndex={1}><a href="mailto:aizaysi.success@gmail.com" target='_blank' rel="noreferrer">My Email: aizaysi.success@gmail.com↗</a></li>
                          <li className="mcq-option" tabIndex={2}><a href="https://twitter.com/aizaysi" target='_blank' rel="noreferrer">My Twitter: @aizaysi ↗</a></li>
                          <li className="mcq-option" tabIndex={3}><a href="https://t.me/AizaysiWeb3" target='_blank' rel="noreferrer">My Telegram: @AizaysiWeb3 ↗</a></li>
                          <li className="mcq-option" tabIndex={4}><a href="https://discord.com/users/775249998379614238" target='_blank' rel="noreferrer">My Discord: aizaysi ↗</a></li>
                        </ul>
                      </div><br />
                    </div>
                  );
                  ...
                  return (
                    ...
                    Create your own personalized Gift Cards as NFTs and lock some cryptos into them. Surprise your friends and family! To not forget any important events users can also schedule gift card transfers. Applications has a template store - a gift card library that can be sent with just a few clicks.
                      ...
                      <li className="mcq-option" tabIndex={0}><a href="https://cardix.Aizaysi.dev" target='_blank' rel="noreferrer">Cardix Website ↗</a></li><br />
                    </div>
                  );
                }
                  ...
                  return (
                    ...
                    Complete copy of Stripe, but for cryptocurrencies. The most customizable solution for receiving automated recurring payments in cryptocurrencies. APIs, webhooks, plugins, BananaPay has it all.<br></br><br></br>
                      ...
                      <li className="mcq-option" tabIndex={0}><a href="https://bananapay.Aizaysi.dev" target='_blank' rel="noreferrer">BananaPay Website ↗</a></li><br />
                    </div>
                  );
                }
                  ...
                  return (
                    <div>
                      ...
                      <div className="mcq-wrapper"><br></br>
                        <ul id="mcq" className="mcq">
                          <li className="mcq-option" tabIndex={0}><a href="https://cardix.Aizaysi.dev/" target='_blank' rel="noreferrer">1. Cardix ↗</a></li>
                          <li className="mcq-option" tabIndex={1}><a href="https://bananapay.Aizaysi.dev/" target='_blank' rel="noreferrer">2. BananaPay ↗</a></li>
                          <li className="mcq-option" tabIndex={2}><a href="https://bullfolio.Aizaysi.dev/" target='_blank' rel="noreferrer">3. BullFolio ↗</a></li>
                          ...
                          <li className="mcq-option" tabIndex={4}><a href="https://Aizaysi.dev" target='_blank' rel="noreferrer">5. Portfolio ↗</a></li>
                          <li className="mcq-option" tabIndex={5}><a href="https://projects.Aizaysi.dev/whiteboard" target='_blank' rel="noreferrer">6. Collaborative Whiteboard ↗</a></li>
                          <li className="mcq-option" tabIndex={6}><a href="https://projects.Aizaysi.dev/simple-chat" target='_blank' rel="noreferrer">7. Token-Gated Chat ↗</a></li>
                          <li className="mcq-option" tabIndex={7}><a href="https://projects.Aizaysi.dev/coin-flip" target='_blank' rel="noreferrer">8. CoinFlip ↗</a></li>
                          <li className="mcq-option" tabIndex={8}><a href="https://projects.Aizaysi.dev/diamond-hands" target='_blank' rel="noreferrer">9. Diamond Hands ↗</a></li>
                          <li className="mcq-option" tabIndex={9}><a href="https://projects.Aizaysi.dev/crypto-tracker" target='_blank' rel="noreferrer">10. Crypto Tracker ↗</a></li>
                          <li className="mcq-option" tabIndex={10}><a href="https://github.com/aizaysi/mobile-wallet" target='_blank' rel="noreferrer">11. Mobile Wallet ↗</a></li>
                  ...
                  return (
                    ...
                    Techstack: React, TypeScript, Solidity, CSS, Firebase
                      <br /><br />
                      <li className="mcq-option" tabIndex={0}><a href="https://bullfolio.Aizaysi.dev" target='_blank' rel="noreferrer">BullFolio Website ↗</a></li><br />
                    </div>
                  );
                }
                  ...
                  return (
                    ...
                    Techstack: React, TypeScript, CSS
                      <br /><br />
                      <li className="mcq-option" tabIndex={0}><a href="https://Aizaysi.dev" target='_blank' rel="noreferrer">Portfolio (this website) ↗</a></li><br />
                    </div>
                  );
                }
                  ...
                  return (
                    ...
                    Techstack: React, TypeScript, CSS, NodeJS, Socket.io
                      <br /><br />
                      <li className="mcq-option" tabIndex={0}><a href="https://github.com/aizaysi/collaborative-canvas" target='_blank' rel="noreferrer">Collaborative Whiteboard Github ↗</a></li><br />
                    </div>
                  );
                }
                  ...
                  return (
                    ...
                    Techstack: HTML, JavaScript, CSS
                      <br /><br />
                      <li className="mcq-option" tabIndex={0}><a href="https://github.com/aizaysi/simple-crypto-chat" target='_blank' rel="noreferrer">Token-Gated Chat Github ↗</a></li><br />
                    </div>
                  );
                }
                  ...
                  return (
                    ...
                    Techstack: React, Solidity, Chainlink, TypeScript, Hardhat
                      <br /><br />
                      <li className="mcq-option" tabIndex={0}><a href="https://github.com/aizaysi/coin-flip" target='_blank' rel="noreferrer">Coin Flip Github ↗</a></li><br />
                    </div>
                  );
                }
                  ...
                  return (
                    ...
                    Techstack: React, Solidity, TypeScript, Hardhat
                      <br /><br />
                      <li className="mcq-option" tabIndex={0}><a href="https://github.com/aizaysi/diamond-hands" target='_blank' rel="noreferrer">Diamond Hands Github ↗</a></li><br />
                    </div>
                  );
                }
                  ...
                  return (
                    ...
                    Techstack: React, CSS, JavaScript
                      <br /><br />
                      <li className="mcq-option" tabIndex={0}><a href="https://github.com/aizaysi/crypto-tracker" target='_blank' rel="noreferrer">Crypto Tracker Github ↗</a></li><br />
                    </div>
                  );
                }
                  ...
                  return (
                    ...
                    Techstack: ReactNative, CSS, JavaScript
                      <br /><br />
                      <li className="mcq-option" tabIndex={0}><a href="https://github.com/aizaysi/mobile-wallet" target='_blank' rel="noreferrer">Mobile Wallet Github ↗</a></li><br />
                    </div>
                  );
                }
                  ...
                  return (
                    ...
                    Techstack: React, TypeScript, Solidity, Chainlink, Hardhat, CSS
                      <br /><br />
                      <li className="mcq-option" tabIndex={0}><a href="https://bananapay-v1.Aizaysi.dev/" target='_blank' rel="noreferrer">BananaPayV1 website ↗</a></li><br />
                    </div>
                  );
                }
                  ...
                  return (
                    <div>
                      <li className="userPrefix" key={index}>{item}</li>
                      <div className='aboutme'><br></br>
                      Hi, nice to meet you. I'm Aizaysi, blockchain and web developer from Slovenia.
                        <br></br><br></br>
                  ...
                  return (
                    <div>
                      <li className="userPrefix" key={index}>{item}</li>
                    bash: {item.replace("guest@Aizaysi.dev:~$", "")}: command not found<br /><br />
                    </div>
                  );
                }
              })}
            </ul>
            {Text3.includes("Access") ? <span className='commands'><span className='userPrefix'>guest@Aizaysi.dev:~$</span> <input type="text" id="command" name="command" autoFocus></input></span> : ""}
          </div>
        ):(
